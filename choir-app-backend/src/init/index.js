...
const { ensureApiTokenExpiryTemplate } = require('./ensureApiTokenExpiryTemplate');
const { ensureOAuthTables } = require('./ensureOAuthTables');
...
async function init(options = {}) {
    ...
    await ensureApiTokenExpiryTemplate();
